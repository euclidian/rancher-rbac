    ...
    <v-navigation-drawer app>
      ...
      <v-list dense class="pt-0">
        ...
        <v-list-tile to="/rancherprojects">
          ...
          <v-list-tile-content>
            <v-list-tile-title>Online Stack</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
        <v-list-tile to="/stack">
          <v-list-tile-action>
            <v-icon>book</v-icon>
          </v-list-tile-action>
          <v-list-tile-content>
            <v-list-tile-title>Stack</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
        <v-list-tile to="/stack_template">
          <v-list-tile-action>
            <v-icon>dashboard</v-icon>
          </v-list-tile-action>
          <v-list-tile-content>
            <v-list-tile-title>Stack Template</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
        <v-list-tile to="/stack_config">
          <v-list-tile-action>
            <v-icon>settings</v-icon>
          </v-list-tile-action>
          <v-list-tile-content>
            <v-list-tile-title>Stack Config</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
